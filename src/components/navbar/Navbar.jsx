          ...
          >
                    ...
                    <div className="grid grid-cols-2 gap-x-4">
                      {category.featured.map((item) => (
                        <div key={item.name} className="group relative text-sm">
                          ...
                          <NavLink to={item.to} className="mt-6 block font-medium text-gray-900">
                        ...
                        >
                          {section.items.map((item) => (
                            <li key={item.name} className="flow-root">
                              <NavLink to={item.to} className="-m-2 block p-2 text-gray-500">
                                {item.name}
                              </NavLink>
                            </li>
                          ))}
            ...
            <div className="space-y-6 border-t border-gray-200 px-4 py-6">
              <div className="flow-root">
                <NavLink to="#" className="-m-2 block p-2 font-medium text-gray-900">
                  Sign in
                </NavLink>
              </div>
              <div className="flow-root">
            ...
            <div className="border-t border-gray-200 px-4 py-6">
              <NavLink to="#" className="-m-2 flex items-center p-2">
                ...
                />
                <span className="ml-3 block text-base font-medium text-gray-900">CMR</span>
            ...
            <div className="flex h-16 items-center">
                                    ...
                                    >
                                      {section.items.map((item) => (
                                        <li key={item.name} className="flex">
                                          <NavLink to={item.to} className="hover:text-gray-800">
                                            {item.name}
                                          </NavLink>
                                        </li>
                                      ))}
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <NavLink to="#" className="text-sm font-medium text-gray-700 hover:text-gray-800">
                    Sign in
                  </NavLink>
